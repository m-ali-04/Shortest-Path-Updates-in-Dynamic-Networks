...
int main(int argc, char** argv) {
    ...
    if (argc != 2) {
        ...
        return 1; // Exit if the number of threads is not provided
    }

    // Convert the command-line argument to an integer for the number of threads
    ...
    std::cout << "Reading time: " << chrono::duration_cast<chrono::milliseconds>(end_read - start_read).count() << " ms\n";
    std::cout << "Saving time: " << chrono::duration_cast<chrono::milliseconds>(end_save - start_save).count() << " ms\n";
    std::cout << "Computation time: " << chrono::duration_cast<chrono::milliseconds>(end_compute - start_compute).count() << " ms\n";
    std::cout << "Total execution time: " << chrono::duration_cast<chrono::milliseconds>(end_total - start_total).count() << " ms\n";
